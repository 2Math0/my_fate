              ...
              child: Wrap(
                ...
                children: [
                  TaskTypeItem(
                      ...
                      leftNum: leftAndDone[AppStrings.personal.toLowerCase()]
                              ["not done"] ??
                          0,
                      doneNum: leftAndDone[AppStrings.personal.toLowerCase()]
                              ["done"] ??
                          0),
                  TaskTypeItem(
                    size: wrapItemsSize(),
                    ...
                    leftNum: leftAndDone[AppStrings.work.toLowerCase()]
                        ...
                        0,
                    doneNum:
                        leftAndDone[AppStrings.work.toLowerCase()]["done"] ?? 0,
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (builder) =>
                                const TaskScreen(category: AppStrings.work))),
                  ),
                  TaskTypeItem(
                      size: wrapItemsSize(),
